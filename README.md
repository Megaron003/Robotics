...
Visit the official profile: [@Unitree](https://github.com/unitree).

I would like thanks to **[@google-deepmind](https://github.com/google-deepmind)** and **[@mujoco](https://github.com/google-deepmind/mujoco)** for:

- 🖥️ Development and validation of a hyper-realistic physics simulation platform.
- 💾 Development focused on different languages in the form of a library (Python and C/C++).
- 🛜 Free and non-exclusive sharing and distribution of intellectual property for use in research and technology development.

Thank you, Google and MuJoCo Team!

Visit the official site and profil: [mujoco.org](https://mujoco.org/) | [@google-deepmind no GitHub](https://github.com/google-deepmind).
